# Generated by Django 3.2.16 on 2023-04-01 12:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('walnut', models.IntegerField(blank=True, default=0, null=True)),
                ('almond', models.IntegerField(blank=True, default=0, null=True)),
                ('fish', models.IntegerField(blank=True, default=0, null=True)),
                ('shellfish', models.IntegerField(blank=True, default=0, null=True)),
                ('shrimp', models.IntegerField(blank=True, default=0, null=True)),
                ('crab', models.IntegerField(blank=True, default=0, null=True)),
